...
export const MANIFEST: ModuleMeta[] = [
  ...
  },
  {
    ...
    slides: [
      { id: "02.01", module: 2, slide: 1, title: { de: "Installation", en: "Installation" } },
      { id: "02.02", module: 2, slide: 2, title: { de: "Authentifizierung", en: "Authentication" } },
      { id: "02.03", module: 2, slide: 3, title: { de: "Modellauswahl", en: "Model selection" } },
      { id: "02.04", module: 2, slide: 4, title: { de: "CLAUDE.md", en: "CLAUDE.md" } },
      { id: "02.05", module: 2, slide: 5, title: { de: "Slash Commands", en: "Slash commands" } },
      { id: "02.06", module: 2, slide: 6, title: { de: "Plan Mode", en: "Plan Mode" } },
      { id: "02.07", module: 2, slide: 7, title: { de: "Permissions", en: "Permissions" } },
      { id: "02.08", module: 2, slide: 8, title: { de: "Hands-on: erste CLAUDE.md", en: "Hands-on: first CLAUDE.md" } },
    ],
  },
  {
    index: 3,
  ...
  },
  {
    ...
    slides: [
      { id: "06.01", module: 6, slide: 1, title: { de: "Vorgehen", en: "Approach" } },
      { id: "06.02", module: 6, slide: 2, title: { de: "Live-Coding", en: "Live coding" } },
